...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void predictImages(View v) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                String appDirctory ="/data/data/"+applicationName+"/";
                String cmdString ="./predict weightsfile=/data/data/"+applicationName+"/directoryTest/weightstTransferedTEST.dat  inputfile=/mnt/sdcard/Download/manifest_mnist_train_test.txt outputfile=/data/data/"+applicationName+"/directoryTest/pred.txt batchsize=32";
